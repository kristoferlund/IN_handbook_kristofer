module.exports = {
  siteTitle: 'Initiativet Handbook', // Site title.
  siteTitleShort: 'IN Handbook', // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation.
